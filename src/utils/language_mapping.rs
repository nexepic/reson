...
pub fn get_language_mapping() -> HashMap<&'static str, Vec<&'static str>> {
    ...
    mapping.insert("javascript", vec!["js", "jsx"]);
    mapping.insert("typescript", vec!["ts", "tsx"]);
...
mod tests {
    ...
    fn test_get_language_from_extension() {
        ...
        assert_eq!(get_language_from_extension("jsx"), Some("javascript"));
        assert_eq!(get_language_from_extension("ts"), Some("typescript"));
        assert_eq!(get_language_from_extension("tsx"), Some("typescript"));
